...
#import "TypeModel.h"
@interface CItyPlayViewController ()
{
...
@implementation CItyPlayViewController
...
- (void)_initHeaderView
{
    ...
    [tickBtn setTitle:@"城市玩乐" forState:UIControlStateNormal];
...
- (void)_requestThisPage
{
    ...
    //请求本地JSON
    id json=[LocalDataRequest requestLocalData:@"城市玩乐"];
