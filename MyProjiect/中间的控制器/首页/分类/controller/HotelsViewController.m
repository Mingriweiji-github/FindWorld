...
//#import "AllTimeViewController.h"
...
- (void)viewDidLoad {
    ...
    layout.itemSize = CGSizeMake((kScreenWidth -10-10-20)/2, 200);
...
- (void)_initHeaderView
{
    ...
    [tickBtn setTitle:@"酒店" forState:UIControlStateNormal];
...
- (void)_iniTabelViews
{
    ...
    myView=[[UIView alloc] initWithFrame:CGRectMake(0, 50, kScreenWidth, kScreenHeight)];
    ...
    departView = [[UIView alloc] initWithFrame:CGRectMake(0, 50, kScreenWidth, kScreenHeight)];
    ...
    //时间视图
    timeView = [[UIView alloc] initWithFrame:CGRectMake(0, 50, kScreenWidth, kScreenHeight)];
    ...
    //目的地
    destinationView = [[UIView alloc] initWithFrame:CGRectMake(0, 50, kScreenWidth, kScreenHeight)];
...
//    NSLog(@"_jsonName is %@",_jsonName);
    id json=[LocalDataRequest requestLocalData:@"酒店"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == self.destinationTabelV && indexPath.row == 5){
        //1.5太平洋-目的地
