...
@interface TuikeyViewController ()
{
...
@implementation TuikeyViewController
...
- (void)requeData
{
    NSMutableDictionary *params=[NSMutableDictionary dictionaryWithObject:@"53964,52180,52178,52170,51467,51420,51395,53605,54301" forKey:@"id"];
